...
# This script are copied from [https://github.com/liyafe1997/kernel_xiaomi_sm8250_mod]. Thanks to liyafe1997.

# Ensure the script exits on error
set -e

TOOLCHAIN_PATH=$HOME/proton-clang/proton-clang-20200711/bin
...
export CCACHE_DIR="$HOME/.cache/ccache_rmx1901_kernel"
